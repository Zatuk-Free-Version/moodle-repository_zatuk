...
$string['email_content_help']  = 'Email of the user for generating the configuration token from zatuk application.';
...
$string['keysecretnotgenerated']  = ' Key and secret has not been generated. Please try again.';
$string['login']  = 'Login';
...
$string['name_content_help']  = 'Name of the user for generating the configuration token from zatuk application.';
...
$string['organization_code_content_help']  = 'Code of the organization for generating the configuration token from zatuk application.';
$string['organization_content']  = 'organization';
$string['organization_content_help']  = 'Name of the organization for generating the configuration token from zatuk application.';
...
$string['zatukvideos'] = 'Videos getting from zatuk application ... {$a->objectid}.';
