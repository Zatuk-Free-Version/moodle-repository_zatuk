...
$string['api_url_zatuk'] = 'Api Url';
$string['api_url_zatuk_help'] = 'Format of URL should be \'https://eabyas.com\'';
$string['api_key_zatuk'] = 'Api Key';
$string['api_key_zatuk_help'] = 'The key info from zatuking application';
$string['secret_zatuk'] = 'Api secret';
$string['secret_zatuk_help'] = 'The Secret info from Streaming application';
...
$string['laravelvideos'] = 'Videos getting from Laravel side ... {$a->objectid}.';
...
$string['organisationcode'] = 'Organisation Code';
...
$string['videotags'] = 'Video tags';
$string['videotitlerequired'] = 'Video title is required';
$string['videofile_help'] = '';
$string['videofilerequired'] = 'Video file is required';
$string['organisation_help'] = '';
$string['tags_help'] = '';
...
$string['serverdown']  = 'The server has been down. Please check with the Zatuk team.';
$string['errormessage']  = 'Please check site configuration settings';

// Repository zatuk access.

$string['privacy:metadata:id'] = 'This is for auto increment id';
$string['privacy:metadata:costcenterid'] = 'This is for cost center id';
$string['privacy:metadata:channelid'] = 'It will contains the cannel id';
$string['privacy:metadata:timemodified'] = 'It will store the time when data is modified ';
$string['privacy:metadata:timecreated'] = 'It will store the time when data is created';
$string['privacy:metadata:usermodified'] = 'It will store the id of user who modified';
$string['search']  = 'Search';
$string['published']  = 'Published';
$string['configuration']  = 'Configuration';
$string['registeration']  = 'Registeration';
