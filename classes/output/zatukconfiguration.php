...
/**
 * repository_zatuk zatukconfiguration class.
 *
...
/**
 * Class zatukconfiguration.
 */
class zatukconfiguration implements renderable, templatable {
    /**
     * @var array $context
     */
    protected $context;
    ...
    public function export_for_template(renderer_base $output) {
        $data = new stdClass;
        $filterform = new configurationform();
